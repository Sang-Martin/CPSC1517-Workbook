...
namespace NorthWindSystem.BLL
{
    ...
    {
        //the interface is a set of methods that can be called by an outside user
        //these methods msut be public

        //generally there are two types of lookups
        ...
        {
            //create a section of code that will ensure the sql connection will be closed
            //  when the method is complete: using(...){...}
        ...
        public List<Region> Region_ListAll()
        {
            using(var context = new NorthWindSystemContext())
            {
                //This extension method will allow
