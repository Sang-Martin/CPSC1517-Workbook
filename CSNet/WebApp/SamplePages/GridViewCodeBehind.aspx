<%@ Page Title="Grid View Code Behind" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GridViewCodeBehind.aspx.cs" Inherits="WebApp.SamplePages.GridViewCodeBehind" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="jumbotron">
            <h1>Filter Search using GredView</h1>
            <blockquote class="col-12 alert alert-info">
                This web page uses only code behind techniques. This page uses a drill down filter search involving a TextBox and GridView. The GridView demonstrates: cusomization, paging and selection.
            </blockquote>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-7">
            ...
            <asp:GridView ID="ProductList" runat="server"
                CssClass="table table-striped" GridLines="Horizontal" BorderStyle="None" AutoGenerateColumns="false" OnSelectedIndexChanged="ProductList_SelectedIndexChanged">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Price ($)">
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# string.Format("{0:0.00}", Eval("UnitPrice")) %>'></asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="QoH">
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("UnitsInStock") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                    </asp:TemplateField>
                </Columns>
