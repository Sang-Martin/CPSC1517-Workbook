...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%-- samples of validation controls
        Controls can be code anywhere on your page they can appear separately in a block or you can place them bedise the associated control
        WARNING!!! if you are using Bootwrap.FreeCode, you CANNOT place the validation control beside the associated input control BECAUSE it violates the Label / Input control pairing
        
        By default each control will have a ErrorMessage
        By default each control will have a Text message which if not changed is the SAME as your ErrorMessage
        The Text message appears on the page where the validation control is physically coded
        The ErrorMessage will appear in the Validation Summary control
        The Text message can be suppressed--%>


    <%-- Required --%>
    <asp:RequiredFieldValidator ID="RequiredFirstName" runat="server" ErrorMessage="First Name is required" SetFocusOnError="true" ForeColor="#990000" ControlToValidate="FirstName" Display="None">
    </asp:RequiredFieldValidator>
    <%-- purposely NOT suppress the Text message --%>
    <asp:RequiredFieldValidator ID="RequiredLastName" runat="server" ErrorMessage="Last Name is required" SetFocusOnError="true" ForeColor="#990000" ControlToValidate="LastName" Display="None">
    </asp:RequiredFieldValidator>

        <asp:RequiredFieldValidator ID="RequiredStreetAddress1" runat="server" ErrorMessage="Street Address 1 is required" SetFocusOnError="true" ForeColor="#990000" ControlToValidate="StreetAddress1" Display="None">
    </asp:RequiredFieldValidator>

        <asp:RequiredFieldValidator ID="RequiredCity" runat="server" ErrorMessage="Last City is required" SetFocusOnError="true" ForeColor="#990000" ControlToValidate="City" Display="None">
    </asp:RequiredFieldValidator>

        <asp:RequiredFieldValidator ID="RequiredPostalCode" runat="server" ErrorMessage="Postal Code is required" SetFocusOnError="true" ForeColor="#990000" ControlToValidate="PostalCode" Display="None">
    </asp:RequiredFieldValidator>

        <asp:RequiredFieldValidator ID="RequiredEmailAddress" runat="server" ErrorMessage="Email Address is required" SetFocusOnError="true" ForeColor="#990000" ControlToValidate="EmailAddress" Display="None">
    </asp:RequiredFieldValidator>

        <asp:RequiredFieldValidator ID="RequiredCheckAnswer" runat="server" ErrorMessage="Answer to skill testing question is required" SetFocusOnError="true" ForeColor="#990000" ControlToValidate="CheckAnswer" Display="None">
    </asp:RequiredFieldValidator>
    ...
    <%-- Yes, I realize that this could have been done using TextMode="Email" directly on the TextBox control --%>
        <asp:RegularExpressionValidator ID="RegExEmailAddress" runat="server" ErrorMessage="Email Address is is invalid" SetFocusOnError="true"
    ...
    <asp:RangeValidator ID="RangeStreetAddress2" runat="server" ErrorMessage="Number must be between 0 and 100" SetFocusOnError="true" ForeColor="Firebrick" Display="None" ControlToValidate="StreetAddress2" MinimumValue="0" MaximumValue="100" Type="Integer">
    </asp:RangeValidator>
    ...
    <%-- a) check the datatype of a control --%>
<%--    <asp:CompareValidator ID="CompareCheckAnswer" runat="server" ErrorMessage="Skill testing value is not a number" SetFocusOnError="true" ForeColor="Firebrick" Display="None" ControlToValidate="CheckAnswer" Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>--%>
    ...
    <%-- c) check the contents of a control against the contents of a second control --%>
    <%--        <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Skill testing is not equal to Street Address 2" SetFocusOnError="true" ForeColor="Firebrick" Display="None" ControlToValidate="CheckAnswer" Operator="Equal" ControlToCompare="StreetAddress2" Type="Integer"></asp:CompareValidator>--%>
    ...
    <div class="row">
        ...
        <div class="col-md-6">   
            <div class="col-md-offset-2">
                <p>
                    <%-- to surpress the automatic client side validator to your control, use the parameter CausesValidation = "false" --%>
                    <asp:Button ID="Submit" runat="server" Text="Submit" OnClick="Submit_Click" />&nbsp;&nbsp;
                    <asp:Button ID="Clear" runat="server" Text="Clear" CausesValidation="true" OnClick="Clear_Click"  />
                </p>
                <asp:Label ID="Message" runat="server" ></asp:Label><br />
                <%-- add a control do display a collection of records similar to using WebGrid in Razor --%>
                <asp:GridView ID="EntryList" runat="server"></asp:GridView>
            </div>
        </div>
    </div>
    <%-- this script tag is REQUIRED for bootwrap.freecode to execute --%>
    <%-- Install Bootwrap from Nuget package --%>
